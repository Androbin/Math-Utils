...
public final class LongFunctionConcurrentMathUtil
{
	...
	public static long[] addAllParallel( final int n, final IntToLongFunction f, final IntToLongFunction g )
	{
		return fillParallel( new long[ n ], i -> f.applyAsLong( i ) + g.applyAsLong( i ) );
	}
	
	public static long[] subAllParallel( final int n, final IntToLongFunction f, final IntToLongFunction g )
	{
		return fillParallel( new long[ n ], i -> f.applyAsLong( i ) - g.applyAsLong( i ) );
	}
}