...
public final class FloatFunctionConcurrentMathUtil {
  ...
  public static float[] addAllParallel( final int n, final IntToFloatFunction f,
      final IntToFloatFunction g ) {
    return fillParallel( new float[ n ], i -> f.applyAsFloat( i ) + g.applyAsFloat( i ) );
  }
  
  public static float[] subAllParallel( final int n, final IntToFloatFunction f,
      final IntToFloatFunction g ) {
    return fillParallel( new float[ n ], i -> f.applyAsFloat( i ) - g.applyAsFloat( i ) );
  }
}