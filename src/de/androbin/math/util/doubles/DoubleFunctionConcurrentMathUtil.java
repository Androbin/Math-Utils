...
public final class DoubleFunctionConcurrentMathUtil
{
	...
	public static double[] addAllParallel( final int n, final IntToDoubleFunction f, final IntToDoubleFunction g )
	{
		return fillParallel( new double[ n ], i -> f.applyAsDouble( i ) + g.applyAsDouble( i ) );
	}
	
	public static double[] subAllParallel( final int n, final IntToDoubleFunction f, final IntToDoubleFunction g )
	{
		return fillParallel( new double[ n ], i -> f.applyAsDouble( i ) - g.applyAsDouble( i ) );
	}
}